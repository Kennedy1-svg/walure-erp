...
<template>
    <div class="relative flex items-center overflow-hidden justify-center h-screen">
        ...
        <div class="z-10 grid lg:max-h-[556px] rounded lg:w-1/2 md:w-2/3 w-full bg-white m-10">
            ...
            <div class="flex justify-center items-center gap-10 mt-6 lg:mb-[60px] mb-7">
                <img src="../../assets/Walure-logo-black.png"  class="w-1/3" alt="walure-logo">
                <img src="../../assets/Ellipsis-1.6s-200px.svg"  class="w-1/6" alt="walure-logo">
                <img src="../../assets/zoho-logo.png"  class="w-1/5" alt="zoho-logo">
            </div>
            <!-- login form -->
            <Redirect class="grid px-10 md:px-16 mb-12 lg:mb-[92px] xl:px-36" />
        </div>
