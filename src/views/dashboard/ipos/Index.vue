...
import IPOContactHeader from '../../../components/dashboard/ipos/IPOContactHeader.vue';
import IPOContactList from '../../../components/dashboard/ipos/IPOContactList.vue';
...
const alertState:any = computed(() => store.getters.getIPOAlertStatus.value)
const alertText:any = computed(() => store.getters.getIPOAlertText.value)
