...
const filter:any = async () => {
    ...
    const request:any = `${api_url}api/iposrequestdemo/search-iposdemo/{pageIndex}/{pageSize}/${search}`;
...
<template>
    <div class="main pt-[50px] grid gap-5 pb-[90px]">
        <div class="top flex justify-between items-center">
            <h1 class="font-semibold text-2xl">Demo Request</h1>
