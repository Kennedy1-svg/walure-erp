...
const submit:any = () => {
    ...
    if (step.value == 1) {
        ...
        isError.value ? step.value = 2 : changeClicked();
        // if (isError.value) {
        //     step.value = 2;
...
<template>
    <div class="main w-full mt-[0.5px] px-[45px] bg-white">
        <div class="flex justify-between py-[53px] items-center ">
            <p class="text-2xl">{{ props.name }} payroll</p>
        ...
        <form id="addexpenditure" class="text-sm text-left grid">
            <div v-if="step == 1">
                <div class="grid grid-cols-2 gap-8 mb-10">
                    ...
                    <div class="grid gap-4">
                        <label for="product" class="font-semibold">
                            Payroll ID <span class="text-red font-bold">*</span>
                        </label>
                    ...
                    <div class="grid gap-4">
                        <label for="category" class="font-semibold">
                            EmployeeID <span class="text-red font-bold">*</span>
                        </label>
                        <input type="text" @focus="checkError" @keyup="checkError"  v-model="newExpenditure.item" name="product" id="product" class="px-4 py-[10px] w-full border rounded-md text-sm focus:outline-none">
                        <p class="text-[10px] text-red">
                ...
                <div class="grid grid-cols-2 gap-8 mb-10">
                    ...
                    <div class="grid gap-4">
                        <label for="category" class="font-semibold">
                            Job Title <span class="text-red font-bold">*</span>
                        </label>
                ...
                <div class="grid grid-cols-2 gap-8 mb-10">
                    ...
                    <div class="grid gap-4">
                        <label for="product" class="font-semibold">
                            New Annual Basic Salary <span class="text-red font-bold">*</span>
                        </label>
                        <multiselect @select="checkError" @clear="checkError"  v-model="newExpenditure.categoryId" valueProp="id" :options="categories" track-by="name" label="name" placeholder="Select option" :searchable="true" class="multiselect-blue" />
                        <!-- <multiselect @select="checkError" @clear="checkError" v-model="newExpenditure.product" valueProp="id" :options="courses" track-by="product" label="product" placeholder="Select option" :searchable="true" class="multiselect-blue" /> -->
                        <p class="text-[10px] text-red">
                    ...
                    <div class="grid gap-4">
                        <label for="category" class="font-semibold">
                            Monthly Basic Salary <span class="text-red font-bold">*</span>
                        </label>
                        <multiselect @select="checkError" @clear="checkError"  v-model="newExpenditure.categoryId" valueProp="id" :options="categories" track-by="name" label="name" placeholder="Select option" :searchable="true" class="multiselect-blue" />
                        <p class="text-[10px] text-red">
                            {{ errors.categoryId ? errors.categoryIdText : '' }}
                ...
                <div class="grid grid-cols-2 gap-8 mb-10 relative">
                    <div class="grid gap-4" id="transactionDate">
                        <label for="transactionDate" class="font-semibold">
                            Monthly Gross Pay <span class="text-red font-bold">*</span>
                        </label>
                        <multiselect @select="checkError" @clear="checkError"  v-model="newExpenditure.categoryId" valueProp="id" :options="categories" track-by="name" label="name" placeholder="Select option" :searchable="true" class="multiselect-blue" />
                        <p class="text-[10px] text-red">
                    ...
                    <div class="grid gap-4 absolute right-0 w-[47%]">
                        <label for="amount" class="font-semibold">
                            Annual Gross Pay <span class="text-red font-bold">*</span>
                        </label>
                        <multiselect @select="checkError" @clear="checkError"  v-model="newExpenditure.categoryId" valueProp="id" :options="categories" track-by="name" label="name" placeholder="Select option" :searchable="true" class="multiselect-blue" />
                        <p class="text-[10px] text-red">
                ...
                <div class="grid grid-cols-2 gap-8 mb-10">
                    <!-- {{ newExpenditure }} -->
                    <div class="grid gap-4 col-span-1 md:col-span-2">
                        <label for="product" class="font-semibold">
                            Employee Name <span class="text-red font-bold">*</span>
                        </label>
                        <multiselect @select="checkError" @clear="checkError"  v-model="newExpenditure.categoryId" valueProp="id" :options="categories" track-by="name" label="name" placeholder="Select option" :searchable="true" class="multiselect-blue" />
            ...
            <div v-if="step == 2">
                <div class="grid grid-cols-2 gap-8 mb-10">
                    ...
                    <div class="grid gap-4">
                        <label for="product" class="font-semibold">
                            Housing Allowance <span class="text-red font-bold">*</span>
                        </label>
                        <input type="text" @focus="checkError" @keyup="checkError"  v-model="newExpenditure.item" name="product" id="product" class="px-4 py-[10px] w-full border rounded-md text-sm focus:outline-none">
                        <!-- <multiselect @select="checkError" @clear="checkError" v-model="newExpenditure.product" valueProp="id" :options="courses" track-by="product" label="product" placeholder="Select option" :searchable="true" class="multiselect-blue" /> -->
                        <p class="text-[10px] text-red">
                    ...
                    <div class="grid gap-4">
                        <label for="category" class="font-semibold">
                            Transport Allowance <span class="text-red font-bold">*</span>
                        </label>
                        <input type="text" @focus="checkError" @keyup="checkError"  v-model="newExpenditure.item" name="product" id="product" class="px-4 py-[10px] w-full border rounded-md text-sm focus:outline-none">
                        <p class="text-[10px] text-red">
                            {{ errors.categoryId ? errors.categoryIdText : '' }}
                ...
                <div class="grid grid-cols-2 gap-8 mb-10">
                    ...
                    <div class="grid gap-4">
                        <label for="product" class="font-semibold">
                            Utility Allowance <span class="text-red font-bold">*</span>
                        </label>
                        <input type="text" @focus="checkError" @keyup="checkError"  v-model="newExpenditure.item" name="product" id="product" class="px-4 py-[10px] w-full border rounded-md text-sm focus:outline-none">
                        <!-- <multiselect @select="checkError" @clear="checkError" v-model="newExpenditure.product" valueProp="id" :options="courses" track-by="product" label="product" placeholder="Select option" :searchable="true" class="multiselect-blue" /> -->
                        <p class="text-[10px] text-red">
                    ...
                    <div class="grid gap-4">
                        <label for="category" class="font-semibold">
                            Clothing Allowance <span class="text-red font-bold">*</span>
                        </label>
                        <input type="text" @focus="checkError" @keyup="checkError"  v-model="newExpenditure.item" name="product" id="product" class="px-4 py-[10px] w-full border rounded-md text-sm focus:outline-none">
                        <p class="text-[10px] text-red">
                            {{ errors.categoryId ? errors.categoryIdText : '' }}
                ...
                <div class="grid grid-cols-2 gap-8 mb-10">
                    ...
                    <div class="grid gap-4">
                        <label for="product" class="font-semibold">
                            Annual Housing Allowance <span class="text-red font-bold">*</span>
                        </label>
                        <input type="text" @focus="checkError" @keyup="checkError"  v-model="newExpenditure.item" name="product" id="product" class="px-4 py-[10px] w-full border rounded-md text-sm focus:outline-none">
                        <!-- <multiselect @select="checkError" @clear="checkError" v-model="newExpenditure.product" valueProp="id" :options="courses" track-by="product" label="product" placeholder="Select option" :searchable="true" class="multiselect-blue" /> -->
                        <p class="text-[10px] text-red">
                    ...
                    <div class="grid gap-4">
                        <label for="category" class="font-semibold">
                            Annual Transport Allowance <span class="text-red font-bold">*</span>
                        </label>
                        <input type="text" @focus="checkError" @keyup="checkError"  v-model="newExpenditure.item" name="product" id="product" class="px-4 py-[10px] w-full border rounded-md text-sm focus:outline-none">
                        <p class="text-[10px] text-red">
                            {{ errors.categoryId ? errors.categoryIdText : '' }}
                ...
                <div class="grid grid-cols-2 gap-8 mb-10 relative">
                    <div class="grid gap-4" id="transactionDate">
                        <label for="transactionDate" class="font-semibold">
                            Annual Utility Allowance <span class="text-red font-bold">*</span>
                        </label>
                        <input type="text" @focus="checkError" @keyup="checkError"  v-model="newExpenditure.item" name="product" id="product" class="px-4 py-[10px] w-full border rounded-md text-sm focus:outline-none">
                        <p class="text-[10px] text-red">
                            {{ errors.transactionDate ? errors.transactionDateText : '' }}
                    ...
                    <div class="grid gap-4 absolute right-0 w-[47%]">
                        <label for="amount" class="font-semibold">
                            Annual Clothing Allowance <span class="text-red font-bold">*</span>
                        </label>
                        <input type="text" @focus="checkError" @keyup="checkError"  v-model="newExpenditure.item" name="product" id="product" class="px-4 py-[10px] w-full border rounded-md text-sm focus:outline-none">
                        <p class="text-[10px] text-red">
                            {{ errors.amount ? errors.amountText : '' }}
                ...
                <div class="grid grid-cols-2 gap-8 mb-10">
                    ...
                    <div class="grid gap-4 col-span-1 md:col-span-2">
                        <label for="product" class="font-semibold">
                            Annual Leave Allowance <span class="text-red font-bold">*</span>
                        </label>
                        <input type="text" @focus="checkError" @keyup="checkError"  v-model="newExpenditure.item" name="product" id="product" class="px-4 py-[10px] w-full border rounded-md text-sm focus:outline-none">
                        <p class="text-[10px] text-red">
                            {{ errors.item ? errors.itemText : '' }}
            ...
            <div class="flex justify-end mt-20 gap-10 pb-10">
                ...
                <button v-if="!isEditing" @click.prevent="submit" class="py-4 px-8 hover:bg-opacity-80 font-bold flex justify-center border text-white rounded-md" :disabled="clicked" :class="[clicked ? 'bg-grey' : 'bg-primary']">{{ step == 1 ? 'Next' : 'Save' }}</button>
                <button v-else @click.prevent="submitEdit" class="py-4 px-8 hover:bg-opacity-80 font-bold flex justify-center border bg-primary text-white rounded-md" :disabled="clicked" :class="[clicked.value ? 'bg-grey-400' : '']">{{ step == 1 ? 'Next' : 'Save Changes' }}</button>
            </div>
        </form>
    </div>
</template>
