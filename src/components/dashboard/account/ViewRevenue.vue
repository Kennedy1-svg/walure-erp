        ...
        <form id="addrevenue" class="text-sm text-left grid">
            <div class="grid grid-cols-2 gap-8 mb-10">
                ...
                <div class="grid gap-4">
                    ...
                    <!-- <input type="text"  v-model="newRevenue.category" name="category" id="category" class="px-4 py-[10px] w-full border rounded-md text-xs focus:outline-none"> -->
                    <multiselect @select="checkError" @clear="checkError"  v-model="newRevenue.categoryId" valueProp="id" :options="categories" track-by="name" label="name" placeholder="Select option" :searchable="true" class="multiselect-blue" disabled="true"/>
